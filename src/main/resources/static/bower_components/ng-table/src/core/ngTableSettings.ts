...
import { assignPartialDeep, checkClassInit } from '../shared/index';
import { IPromise } from 'angular';
import { Defaults } from './ngTableDefaults';
import { DataRowGroup, DataSettingsPartial, DataSettings, DefaultGetData, GetDataFunc, Interceptor, InterceptableGetDataFunc } from './data/index';
import { FilterValues, FilterSettingsPartial, FilterSettings } from './filtering/index';
import { GetGroupFunc, GroupSettingsPartial, GroupSettings } from './grouping/index';
import { SortDirection } from './sorting/index';
